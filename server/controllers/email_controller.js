...
module.exports = {
	send_email: function(req, res){
		...
		var mailOptions = {
			...
			text: "", // plaintext body
			html: `<h2>You've been assigned a group for ${req.body.restaurant_name} at ${req.body.group_time}</h2><br><p>Here is your group coupon. Be sure to bring it with you!</p><img src="http://i.imgur.com/b8kW1M9.png">`// html body
		};
